    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
          ...
          .antMatchers(HttpMethod.OPTIONS, "/**")
                .permitAll()
          .antMatchers("/home", "/login", "/token", "/login/v1" , "/register", "/passwordForgotten","/upload","/skills/*" , "/qualifications/*","/subscriptions/*","/usersbyId/{id}") // les pages/requêtes /home, /login et /token sont accessibles sans authentifications (pour pouvoir s'identifier).
                .permitAll()
          .anyRequest()
