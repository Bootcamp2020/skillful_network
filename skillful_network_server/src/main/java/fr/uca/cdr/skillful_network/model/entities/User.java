...
public class User {
   ...
   private boolean photo= false;
	...
	@ManyToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)//,mappedBy="SkillsSihem")//, fetch = FetchType.EAGER)
	private Set<Skill>skillSet = new HashSet<Skill>();

	@ManyToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER)//,mappedBy="QualificationsSihem")//, fetch = FetchType.EAGER)
